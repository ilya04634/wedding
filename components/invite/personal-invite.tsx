      ...
      <section className="relative z-10 mx-auto flex min-h-[100dvh] max-w-4xl flex-col justify-between px-4 py-6 text-center sm:px-8 sm:py-10">
        ...
        <div className="mx-auto flex max-w-2xl flex-1 flex-col items-center justify-center py-8 drop-shadow-[0_2px_18px_rgba(0,0,0,0.5)] sm:py-12">
          ...
          <div className="mt-7 grid w-full max-w-lg gap-2 text-sm text-white/90 sm:mt-9 sm:grid-cols-3 sm:gap-3">
            <p className="flex min-h-12 items-center justify-center gap-2 rounded-md border border-white/35 bg-black/20 px-3 py-3 backdrop-blur-[2px]">
              <Calendar className="h-4 w-4 shrink-0" aria-hidden />
              <span>{settings.weddingTime}</span>
            </p>
            <p className="flex min-h-12 items-center justify-center gap-2 rounded-md border border-white/35 bg-black/20 px-3 py-3 backdrop-blur-[2px] sm:col-span-2">
