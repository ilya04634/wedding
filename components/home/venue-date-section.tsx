  ...
  return (
    <section className="figma-frame-section scroll-mt-24">
      <div className="figma-phone-frame text-black">
        <Image
          src="/figma-wedding/venue-heart.png"
          alt=""
          width={124}
          height={124}
          className="absolute size-[124px] object-cover"
          style={{ left: "calc(40% - 20.8px)", top: "calc(55% + 20.95px)" }}
          aria-hidden
        />

        <div
          className="absolute h-[362px] w-[266px] overflow-hidden"
        ...
        <div
          className="absolute flex h-[303.227px] w-[253.765px] items-center justify-center"
        ...
        <div
          className="absolute flex h-[24.856px] w-[16.937px] items-center justify-center"
        ...
        <p
          className="absolute whitespace-nowrap font-figma-script text-[24px] leading-[0.89] text-black"
          style={{
        ...
        <p
          className="absolute whitespace-nowrap font-display text-[28px] uppercase leading-none tracking-[0.56px] text-[#397c57]"
          style={{
        ...
        <p
          className="absolute whitespace-nowrap font-display text-[26px] leading-none tracking-[0.52px] text-[#397c57]"
          style={{
        ...
        <div
          className="absolute w-[218px] text-center font-display text-[17px] leading-normal tracking-[0.34px] text-black"
          style={{
            left: "calc(40% - 6.22px)",
            top: "calc(20% + 8.57px)",
            transform: "translateX(-50%) rotate(-5.54deg)",
        ...
        <a
          ...
          className="absolute flex h-[27.929px] w-[184px] items-center justify-center bg-[#397c57] font-display text-[14px] tracking-[0.28px] text-white"
          style={{
        ...
        {days.map((date, index) => {
          ...
          return (
            <p
              key={date}
              className={`absolute font-display leading-none tracking-[0.72px] text-[#193726] ${
        ...
        <div
          className="absolute flex h-[219.057px] w-[239.043px] items-center justify-center"
        ...
        <div
          className="absolute h-[50px] w-[48px] overflow-hidden"
        ...
        <div
          className="absolute flex h-[90.444px] w-[90.283px] items-center justify-center"
